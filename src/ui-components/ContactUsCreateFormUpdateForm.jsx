...
import { getContactUsCreateForm } from "../graphql/queries";
import { updateContactUsCreateForm } from "../graphql/mutations";
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? (
            await API.graphql({
              query: getContactUsCreateForm,
              variables: { id: idProp },
            })
          )?.data?.getContactUsCreateForm
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: updateContactUsCreateForm,
            variables: {
              input: {
                id: contactUsCreateFormRecord.id,
                ...modelFields,
              },
            },
          });
